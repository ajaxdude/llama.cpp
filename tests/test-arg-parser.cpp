...
static void test(void) {
...

    {
        ...
        uint32_t fit_context_max = 131072;
        uint32_t fit_context_min = 4096;
        common_fit_context_bounds_apply_arch_defaults(
                "deepseek41", model_params, fit_context_max, fit_context_min);
        assert(fit_context_max == 32768);
        assert(fit_context_min == 32768);

        uint32_t standard_context_max = 131072;
        uint32_t standard_context_min = 4096;
        common_fit_context_bounds_apply_arch_defaults(
                "qwen4exp", model_params, standard_context_max, standard_context_min);
        assert(standard_context_max == 131072);
        assert(standard_context_min == 4096);
